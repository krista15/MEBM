...
% hydrologic response to regional noise
...
% White Noise
noise = ones(jmx,1)*10.0*randn(1,tf);
...
[GLOBAL_EMP,GLOBAL_E,GLOBAL_T] = tseries(tf,GLOBAL);
[TROP_EMP,TROP_E,TROP_T] = tseries(tf,TROP);
[MLAT_EMP,MLAT_E,MLAT_T] = tseries(tf,MLAT);
[POLAR_EMP,POLAR_E,POLAR_T] = tseries(tf,POLAR);
...
% plot(x,mean(GLOBAL_EMP'),'linewidth',2); hold on;grid on;
% plot(x,mean(TROP_EMP'),'linewidth',2); hold on;
% plot(x,mean(MLAT_EMP'),'linewidth',2); hold on;
% plot(x,mean(POLAR_EMP'),'linewidth',2);
% title('evap - precip')
...
% xt = sind(xt);
% xtl = ['-80'; '-60'; '-45'; '-30'; '-15'; '  0'; ' 15'; ' 30'; ' 45'; ' 60';' 80'];
% plot(x,mean(GLOBAL_E'),'linewidth',2); hold on;grid on;
% plot(x,mean(TROP_E'),'linewidth',2); hold on;
% plot(x,mean(MLAT_E'),'linewidth',2); hold on;
% plot(x,mean(POLAR_E'),'linewidth',2);
% title('evap')
% legend('Global noise','Tropic noise','Midlat noise','Polar noise')
% xlabel('latitude')
% ylabel('W m^{-2}')
...
xt = sind(xt);
xtl = ['-80'; '-60'; '-45'; '-30'; '-15'; '  0'; ' 15'; ' 30'; ' 45'; ' 60';' 80'];
% plot(x,mean(GLOBAL_P'),'linewidth',2); hold on;grid on;
% plot(x,mean(TROP_P'),'linewidth',2); hold on;
% plot(x,mean(MLAT_P'),'linewidth',2); hold on;
% plot(x,mean(POLAR_P'),'linewidth',2);
% title('precip')
% legend('Global noise','Tropic noise','Midlat noise','Polar noise')
% xlabel('latitude')
% ylabel('W m^{-2}')
...
% figure
subplot(1,2,1)
plot(time,TROP_EMP(1,:),'linewidth',2,'Color',"#D95319"); hold on; 
plot(time,TROP_EMP(7,:),'linewidth',2,'Color',"#D95319"); hold on;
plot(time,TROP_EMP(19,:),'linewidth',2,'Color',"#D95319"); hold on;
plot(time,TROP_EMP(34,:),'linewidth',2,'Color',"#D95319"); hold on;
plot(time,TROP_EMP(51,:),'linewidth',2,'Color',"#D95319"); hold on;
plot(time,GLOBAL_EMP(1,:),'linewidth',2,'Color',"#0072BD"); hold on; grid on;
plot(time,GLOBAL_EMP(7,:),'linewidth',2,'Color',"#0072BD"); hold on;
plot(time,GLOBAL_EMP(19,:),'linewidth',2,'Color',"#0072BD"); hold on;
plot(time,GLOBAL_EMP(34,:),'linewidth',2,'Color',"#0072BD"); hold on;
plot(time,GLOBAL_EMP(51,:),'linewidth',2,'Color',"#0072BD"); hold on;
plot(time,MLAT_EMP(1,:),'linewidth',2,'Color',"#EDB120"); hold on; 
plot(time,MLAT_EMP(7,:),'linewidth',2,'Color',"#EDB120"); hold on;
plot(time,MLAT_EMP(19,:),'linewidth',2,'Color',"#EDB120"); hold on;
plot(time,MLAT_EMP(34,:),'linewidth',2,'Color',"#EDB120"); hold on;
plot(time,MLAT_EMP(51,:),'linewidth',2,'Color',"#EDB120"); hold on;
plot(time,POLAR_EMP(1,:),'linewidth',2,'Color',"#7E2F8E"); hold on; 
plot(time,POLAR_EMP(7,:),'linewidth',2,'Color',"#7E2F8E"); hold on;
plot(time,POLAR_EMP(19,:),'linewidth',2,'Color',"#7E2F8E"); hold on;
plot(time,POLAR_EMP(34,:),'linewidth',2,'Color',"#7E2F8E"); hold on;
plot(time,POLAR_EMP(51,:),'linewidth',2,'Color',"#7E2F8E"); 
title('evap - precip')
xlabel('year')
ylabel('W m^{-2}')

GLOBAL_V = var(GLOBAL_EMP')';
POLAR_V = var(POLAR_EMP')';
MLAT_V = var(MLAT_EMP')';
TROP_V = var(TROP_EMP')';
...
title('evap-precip variance across time')
legend('Global noise','Tropic noise','Midlat noise','Polar noise')
xlabel('latitude')
ylabel('W m^{-2} squared')
set(gca,'XTick',xt);
set(gca,'XTicklabel',xtl);

GLOBAL_VE = var(GLOBAL_E')';
POLAR_VE = var(POLAR_E')';
MLAT_VE = var(MLAT_E')';
TROP_VE = var(TROP_E')';

GLOBAL_VT = var(GLOBAL_T')';
POLAR_VT = var(POLAR_T')';
MLAT_VT = var(MLAT_T')';
TROP_VT = var(TROP_T')';

figure
subplot(1,2,1)
plot(x,GLOBAL_VE,'linewidth',2); hold on;grid on;
plot(x,TROP_VE,'linewidth',2); hold on;
plot(x,MLAT_VE,'linewidth',2); hold on;
plot(x,POLAR_VE,'linewidth',2);
title('evap variance across time')
legend('Global noise','Tropic noise','Midlat noise','Polar noise')
xlabel('latitude')
ylabel('W m^{-2} squared')
set(gca,'XTick',xt);
...
subplot(1,2,2)
plot(x,GLOBAL_VT,'linewidth',2); hold on;grid on;
plot(x,TROP_VT,'linewidth',2); hold on;
plot(x,MLAT_VT,'linewidth',2); hold on;
plot(x,POLAR_VT,'linewidth',2);
title('temp variance across time')
legend('Global noise','Tropic noise','Midlat noise','Polar noise')
xlabel('latitude')
ylabel('deg C squared')
set(gca,'XTick',xt);
set(gca,'XTicklabel',xtl);
ax = gca;

function [emp_,e_,t_] = tseries(t_end,noise_in)
